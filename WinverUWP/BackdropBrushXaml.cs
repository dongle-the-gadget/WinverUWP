...
namespace WinverUWP
{
    public class BackdropBrushXaml : XamlCompositionBrushBase
    {
        public BackdropBrushXaml()
        {
            ...
            _wallpaperBrushSupported = Windows.Foundation.Metadata.ApiInformation.IsMethodPresent(typeof(Compositor).FullName, nameof(Compositor.TryCreateBlurredWallpaperBackdropBrush));
        }
