...
#pragma warning restore CS0649
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public Interop.HRESULT ExistsByPackageFamilyName(Interop.HSTRING packageFamilyName, uint* result)
    {
        return ((delegate* unmanaged[Stdcall]<IPackageStatics_StateRepository*, Interop.HSTRING, uint*, int>)lpVtbl[37])((IPackageStatics_StateRepository*)Unsafe.AsPointer(ref this), packageFamilyName, result);
    }
}
#endif